        ...
        <div class="authentication-wrapper authentication-basic container-p-y">
            <div class="authentication-inner">
                          ...
                          <g id="Icon" transform="translate(27.000000, 15.000000)">
                            ...
                            <g
                              ...
                              <use fill-opacity="0.2" fill="#FFFFFF" xlink:href="#path-5"></use>
                                    ...
                                    <img height="120" width="150" src="assets/images/resources/sticky-logo.png" alt=""
                                        srcset="">
                                </span>
              ...
              <p class="mb-6">Make your app management easy and fun!</p> -->
                        ...
                        <form id="formAuthentication" method="POST" class="mb-6" action="signup.php">
                            <!-- Username Field -->
                            <div class="mb-6">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" class="form-control" id="emergencyContactPhone"
                                    name="emergencyContactPhone" placeholder="Enter emergency contact phone" />
                            ...
                            <div class="mb-6">
                                ...
                                <select class="form-control" id="role" name="role">
                                    ...
                                    <option value="driver">Driver/EMT</option>
                                </select>
                            ...
                            <button id="signup" type="submit" class="btn btn-primary d-grid w-100">Sign up</button>
                        </form>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#formAuthentication').submit(function (event) {
                ...
                validateField('#username', isValidName, 'Username should contain only letters.');
            ...
            $('#username, #email, #password, #phone, #address, #emergencyContactName, #emergencyContactPhone, #role').on('input focusout', function () {
                var fieldId = $(this).attr('id');

                // Validate the field individually
                if (fieldId === 'username') {
                    validateField(this, isValidName, 'Username should contain only letters.');
                    ...
                    validateField(this, isValidName, 'Emergency Contact Name should contain only letters.');
                    ...
                    validateField(this, function (role) { return role !== ""; }, 'Please select a role.');
                }
            });
        });
