                            ...
                            <div class="col-xxl-8 mb-6 order-0">
                                <div class="card">
                                    <div class="d-flex align-items-start row">
                                        <div class="col-sm-7">
                                            <div class="card-body">
                                                <h5 class="card-title text-primary mb-3">Welcome <?= $username ?>! 🎉
                                                </h5>
                                                <p class="mb-6">You are currently logged in to the Ambulance Management
                                                    System. Below are your assigned tasks and emergency requests.</p>
                                                    <a href="./requests.php" class="btn btn-sm btn-label-primary">View Active Tasks</a>
                                            </div>
                                        </div>
