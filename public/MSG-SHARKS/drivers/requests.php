                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            ...
                            <div class="col-xxl-4 col-lg-12 col-md-4 order-1">
                                <div class="row">
                                    <?php
                                    // Assuming a PDO connection is already established and $driverId is available
                                    $query = "SELECT er.request_id, er.hospital_name, er.pickup_address, er.status, er.type, er.updated_at 
                                    FROM emergency_requests er 
                                    WHERE er.driver_id = $driverId AND er.status IN ('dispatched','arrived','on-route')
                                    ORDER BY er.updated_at DESC";
                                    $emergencyRequests = $db->fetchAll($query);
                                        ...
                                        foreach ($emergencyRequests as $request) {
                                            ...
                                            <div class="col-md-12 mb-3">
                                                <div class="card h-100">
                                                    <div class="card-body">
                                                        <h5 class="card-title">Request #<?= $request['request_id'] ?>
                                                        </h5>
                                                        <p class="card-text">
                                                            ...
                                                            <?= date('F j, Y, g:i a', strtotime($request['updated_at'])) ?>
                                                        </p>
                                                        <a href="request-details.php?id=<?= $request['request_id'] ?>"
                                        ...
                                        <div class="col-md-12">
                                            <div class="card h-100">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">You have no active emergency requests at this
                                                        moment. Stay ready for the next task.</p>
                                                </div>
                                            </div>
                                        </div>
                                    <?php } ?>
