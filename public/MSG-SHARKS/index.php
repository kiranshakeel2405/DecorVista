...
<!-- Mirrored from mehedi.asiandevelopers.com/ambons/index# by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Sep 2024 13:13:38 GMT -->
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="outer-box">
                        ...
                        <div class="header-right">
                            <div class="header-social-link">
                                <a style="padding: 0px 31px;" class="btn-one" href="./login.php">Login</a>
                            </div>
                            <div class="header-social-link mx-3">
                                <a style="padding: 0px 31px;" class="btn-one" href="./signup.php">Signup</a>
                            </div>
                        </div>
                        <!--End Header Right-->
                    ...
                    <div class="clearfix">
                        ...
                        <div class="logo float-left">
                            <a href="#" class="img-responsive">
                                <img class="logo_image" src="assets/images/resources/sticky-logo.png" alt="" title="">
                            </a>
                        </div>
                        <!--Right Col-->
                    ...
                    <div class="col-xl-6">
                        <div class="about-style1__content">
                            ...
                            <div class="inner-content">
                                <div class="text">
                                    <p>Your health is our top priority. As a leading medical service provider, we are dedicated to providing patient-centered care.</p>
                                </div>
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="single-text-box">
                                            <h3><span class="icon-right-arrow"></span>Help us Save a Life</h3>
                                            <p>Every second counts in a medical emergency. By choosing our medical services, you're not just choosing healthcare; you're choosing life</p>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="single-text-box">
                                            <h3><span class="icon-right-arrow"></span>Join our Big Family</h3>
                                            <p>Become a part of our dedicated team of healthcare professionals. We are always looking for compassionate and skilled individuals to join our growing family</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="btns-box">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="single-service-style1 wow fadeInUp" data-wow-delay="100ms"
                            ...
                            <div class="text-holder">
                                <h3><a href="#"> Rapid Response for Critical Situations</a></h3>
                                <p>Our dedicated emergency response team is available 24/7 to provide swift and efficient medical assistance for life-threatening emergencies.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="single-service-style1 wow fadeInDown" data-wow-delay="100ms"
                            ...
                            <div class="text-holder">
                                <h3><a href="#">Safe and Comfortable Transportation</a></h3>
                                <p>Need reliable transportation for non-urgent medical appointments or treatments? Our comfortable and well-equipped ambulances ensure a safe and hassle-free journey.</p>
                            </div>
                        </div>
                    </div>
                    <!--End Single Service Style1-->
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="single-service-style1 wow fadeInUp" data-wow-delay="100ms"
                            ...
                            <div class="text-holder">
                                <h3><a href="#">Compassionate Care, Every Step of the Way</a></h3>
                                <p>Our experienced medical professionals are committed to providing compassionate care and support throughout your entire journey, from the initial emergency call to the hospital and beyond.</p>
                            </div>
                        </div>
                    </div>
                    <!--End Single Service Style1-->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="features-style2__title">
                            ...
                            <div class="text">
                                <p>We're at the forefront of emergency medical services. We provide our employees with access to the latest technology and equipment, ensuring that we can deliver the highest quality of care to our patients.
                        ...
                        <ul class="features-style2__content">
                            ...
                            <li class="single-features-style2" data-aos="fade-left" data-aos-easing="linear"
                                ...
                                <div class="text-holder">
                                    ...
                                    <p>Longstanding service, unwavering trust. For decades, we've been providing reliable and compassionate ambulance services to the community.</p>
                                </div>
                            </li>
                            ...
                            <li class="single-features-style2" data-aos="fade-right" data-aos-easing="linear"
                                ...
                                <div class="text-holder">
                                    ...
                                    <p>Our emergency response team is meticulously trained and equipped to handle a wide range of medical emergencies</p>
                                </div>
                            </li>
                            <!--End single Features Style2-->
                            <!--Start single Features Style2-->
                            <li class="single-features-style2" data-aos="fade-left" data-aos-easing="linear"
                                ...
                                <div class="text-holder">
                                    ...
                                    <p>We're more than just an ambulance service; we're your partners in healthcare.</p>
                                </div>
                            </li>
                            <!--End single Features Style2-->
                            <!--Start single Features Style2-->
                            <li class="single-features-style2" data-aos="fade-right" data-aos-easing="linear"
                                ...
                                <div class="text-holder">
                                    ...
                                    <p>We provide high-quality services at competitive prices without compromising on patient safety.</p>
                                </div>
                            </li>
                            <!--End single Features Style2-->
...
<!--Start Partner Area-->
<section style="padding-top:120px" class="partner-area">
            <div class="container">
                                ...
                                <div class="single-footer-widget margintop">
                                    ...
                                    <div class="footer-widget-links">
                                        <ul>
                                            ...
                                            <li><a href="#">Private Air Ambulance</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="footer-bottom">
                    <div class="container">
                        <div class="bottom-inner">
                            <div class="copyright">
                                <p>Copyright &copy; 2022 <a href="#">Ambons</a> All Rights Reserved.</p>
                            </div>
        ...
        <div id="search-popup" class="search-popup">
            ...
            <div class="popup-inner">
                ...
                <div class="search-form">
                    <form method="post" action="https://mehedi.asiandevelopers.com/ambons/index#">
...
<!-- Mirrored from mehedi.asiandevelopers.com/ambons/index# by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Sep 2024 13:14:14 GMT -->
</html>