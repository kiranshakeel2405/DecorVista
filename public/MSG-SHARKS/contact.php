...
<!-- Mirrored from mehedi.asiandevelopers.com/ambons/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Sep 2024 13:13:38 GMT -->
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="col-xl-6">
                        <div class="contact-info-style1__content">
                            ...
                            <div class="inner-content">
                                <div class="text">
                                    <p>We're here to help you 24/7. Whether you need emergency assistance, have a question about our services, or want to give us feedback, our team is always ready to assist you. Reach out to us through any of the following means:</p>
                                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="contact-form">
                            <form id="contact-form" name="contact_form" class="default-form2"
                                action="https://mehedi.asiandevelopers.com/ambons/assets/inc/sendmail.php" method="post">
                                    ...
                                    <div class="col-xl-12 text-center">
                                        <div class="button-box">
                                            <input id="form_botcheck" name="form_botcheck" class="form-control"
                                                type="hidden" value="">
                                            <button onclick="showMessage()" class="btn-one" type="submit">
                                                <span class="txt">
                                                    send a message
                                                </span>
                                            </button>
                                ...
                                <div class="single-footer-widget single-footer-widget--link-box margintop marbtm50">
                                    ...
                                    <div class="footer-widget-links">
                                        <ul>
                                            ...
                                            <li><a href="about.php">Flight Crews</a></li>
                ...
                <div class="footer-bottom">
                    <div class="container">
                        <div class="bottom-inner">
                            <div class="copyright">
                                <p>Copyright &copy; 2022 <a href="index.php">Ambons</a> All Rights Reserved.</p>
                            </div>
...
<!-- Mirrored from mehedi.asiandevelopers.com/ambons/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Sep 2024 13:14:14 GMT -->
</html>