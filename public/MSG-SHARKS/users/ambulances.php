...
$ambulanceId = (isset($_GET['id']))?$_GET['id']:0;
$where = '';
if($ambulanceId > 0){
    $where .= "AND ambulance_id = $ambulanceId";
}
include '../config.php';
$db = new Database();
...
$query = "SELECT * FROM ambulances WHERE is_deleted = '0' $where";
                            ...
                            <div class="card mb-6">
                                <div class="card-header d-flex flex-wrap justify-content-between gap-4">
                                    <div class="card-title mb-0 me-1">
                                        <h5 class="mb-0">ALL AMBULANCES</h5>
                                        <p class="mb-0">See our service</p>
                                    </div>
                                    <?php
                                        if($ambulanceId == 0){ 
                                    ?>
                                    <div class="mb-6">
                                        ...
                                        <select onchange="filterAmbulance()" class="form-control" id="type" name="type">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <select onchange="filterAmbulance()" class="form-control" id="status" name="status">
                                            <option value="">Select Status</option>
                                            <option value="available">Available</option>
                                            <option value="on-duty">Non-Emergency</option>
                                ...
                                <div class="card-body">
                                    <div id="ambulanceData" class="row gy-6 mb-6">
                                        <?php 
                                            ...
                                            <div class="card p-2 h-100 shadow-none border">
                                                ...
                                                <div class="card-body p-4 pt-2">
                                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                                        ...
                                                        ?>
                                                        <span class="badge <?= $badge ?>"><?= $ambulance['status'] ?></span>
                                                    ...
                                                    <div
                                                        ...
                                                        <a class="w-100 btn btn-label-primary d-flex align-items-center"
                                                            href="#">
                                                            <span class="me-2"><?= $ambulance['size'] ?></span><i
    ...
    <script>
        function filterAmbulance(){
            ...
            let data = {
                type:type,
                status:status,
                requestType:"filterAmbulance"
            }
            $.post('./users-logic.php',data,function(response){
                let result = JSON.parse(response);
                if(result.status == 1){
                    $('#ambulanceData').html('');
                    $('#ambulanceData').html(`${result.html}`)
                }else{
