...
$driverDetails = $db->fetchSingle($query);
?>
<!doctype html>
                                    ...
                                    <div class="card-body pt-12">
                                        <div class="customer-avatar-section">
                                            <div class="d-flex align-items-center flex-column">
                                                ...
                                                <div class="customer-info text-center mb-6">
                                                    <h5 class="mb-0"><?= $driverDetails['name'] ?></h5>
                                                    <span>User ID #<?= $driverDetails['user_id'] ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="info-container">
                                            ...
                                            <ul class="list-unstyled mb-6">
                                                <li class="mb-2">
                                                    <span class="h6 me-1">Driver Name:</span>
                                                    <span><?= $driverDetails['name'] ?></span>
                                                </li>
                                                <li class="mb-2">
                                                    <span class="h6 me-1">Address:</span>
                                                    <span><?= $driverDetails['address'] ?></span>
                                                </li>
                                                <li class="mb-2">
                                                    <span class="h6 me-1">License Number:</span>
                                                    <span><?= isset($driverDetails['license_number'])?$driverDetails['license_number']:'No details to show' ?></span>
                                                </li>
                                                
                                                <li class="mb-2">
                                                    <span class="h6 me-1">Contact:</span>
                                                    <span><?= $driverDetails['contact_number'] ?></span>
                                                </li>
