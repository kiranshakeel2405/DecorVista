...
<body>
                            ...
                            <div class="col-xxl">
                                <div class="card mb-6">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        <h5 class="mb-0">AMBULANCE REQUEST</h5> <small class="text-muted float-end">Save
                                            Life</small>
                                    </div>
                                    <div class="card-body">
                                        <form id="AmbulanceRequestForm">
                                            <div class="row mb-6">
                                                <label class="col-sm-2 col-form-label" for="basic-default-name">Hospital
                                                    Name</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="hospitalname"
                                                        placeholder="Enter Hospital Name">
                                                    <span class="error-message" id="hospitalname-error"></span>
                                                    <input hidden id="userId" type="text" value="<?= $userId ?>">
                                                </div>
                                            </div>
                                            <div class="row mb-6">
                                                <label class="col-sm-2 col-form-label"
                                                    for="basic-default-company">Hospital Address</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="hospitaladdress"
                                                        placeholder="Enter Hospital Address">
                                                    <span class="error-message" id="hospitaladdress-error"></span>
                                                </div>
                                            </div>
                                            <div class="row mb-6">
                                                <label class="col-sm-2 col-form-label"
                                                    for="basic-default-company">Pickup Address</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="pickupaddress"
                                                        placeholder="Enter Pickup Address">
                                                    <span class="error-message" id="pickupaddress-error"></span>
                                                </div>
                                            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#AmbulanceRequestForm').submit(function (event) {
            ...
            $('#username,#hospitaladdress,#pickupaddress, #type').on('input focusout', function () {
                var fieldId = $(this).attr('id');

                // Validate the field individually
                if (fieldId === 'hospitalname') {
                    validateField(this, isValidName, 'Hospital name should contain only letters.');
                } else if (fieldId === 'hospitaladdress') {
                    validateField(this, function (addr) { return addr.trim() !== ""; }, 'Hospital Address cannot be empty.');
                } else if (fieldId === 'pickupaddress') {
                    validateField(this, function (addr) { return addr.trim() !== ""; }, 'Pickup Address cannot be empty.');
