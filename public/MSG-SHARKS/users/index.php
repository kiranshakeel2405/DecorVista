                            ...
                            <div class="col-xxl-8 mb-6 order-0">
                                <div class="card">
                                    <div class="d-flex align-items-start row">
                                        <div class="col-sm-7">
                                            <div class="card-body">
                                                <h5 class="card-title text-primary mb-3">Welcome <?= $username ?>! 🎉</h5>
                                                <p class="mb-6">Welcome to our Ambulance Management System. We're here to assist you in providing life-saving care.</p>

                                                <a href="./request.php" class="btn btn-sm btn-label-primary">Book Request</a>
                                            </div>
                                        </div>
