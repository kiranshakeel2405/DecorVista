...
$query = "SELECT * FROM drivers WHERE is_deleted = '0'";
                                ...
                                if (count($drivers) > 0) {
                                    foreach ($drivers as $request) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="./edit-driver.php?id=<?= $request['driver_id'] ?>"><i class="bx bx-edit bx-md"></i></a><a onclick="deleteItem(<?= $request['driver_id'] ?>)" href="javascript:void(0)" ><i class="bx bx-trash bx-md"></i></a></td>
                                        </tr>
                                        <?php
                                    }
                                }
