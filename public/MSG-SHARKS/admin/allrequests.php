...
$query = "SELECT emergency_requests.*,drivers.name,users.name as username FROM emergency_requests LEFT JOIN drivers ON emergency_requests.driver_id = drivers.driver_id LEFT JOIN users ON users.user_id = emergency_requests.user_id WHERE emergency_requests.is_deleted = '0'";
                                    ...
                                    foreach ($allRequests as $request) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <a href="./dispatch.php?id=<?= $request['request_id'] ?>"><i
                                                        class="bx bx-edit bx-md"></i></a>

                                                <?php
                                                    }else{
                                                ?>
                                                <a href="./request-detail.php?id=<?= $request['request_id'] ?>"><i
                                                class="bx bx-edit bx-md"></i></a>
                                                <?php }?>
                                                <a href="./viewfeedback.php?id=<?= $request['request_id'] ?>"><i class="bx bx-message-square-dots bx-md"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
