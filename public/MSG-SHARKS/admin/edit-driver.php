...
<body>
                            ...
                            <div class="col-xxl">
                                <div class="card mb-6">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        <h5 class="mb-0">MODIFY DRIVER STATUS</h5> <small class="text-muted float-end">Save Life</small>
                                    </div>
                                    <div class="card-body">
                                        <form id="ModifyDriver">
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-control" id="status" name="status">
                                                        ...
                                                        <option <?= ($driver['status'] == 'available')?'selected':'' ?> value="available">Available</option>
                                                        <option <?= ($driver['status'] == 'off-duty')?'selected':'' ?> value="off-duty">Off-Duty</option>
                                                    </select>
                                                    <span class="error-message" id="type-error"></span>
                                                    <input hidden id="driver_id" type="text" value="<?= $driverId ?>">
                                                </div>
                                            </div>
                                            <div class="row mb-6">
                                                <label class="col-sm-2 col-form-label"
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="licensenumber"
                                                        placeholder="Enter License Number" value="<?= isset($driver['license_number'])?$driver['license_number']:'' ?>">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#ModifyDriver').submit(function (event) {
                ...
                validateField('#status', function (role) { return role !== ""; }, 'Please select a status.');
