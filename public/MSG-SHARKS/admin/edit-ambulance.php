...
$query = "SELECT * FROM ambulances WHERE ambulance_id = '$ambulanceId'";
$ambulance = $db->fetchSingle($query);
?>
<!doctype html>
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="ambulancenumber"
                                                        placeholder="Enter Ambulance Number" value="<?= $ambulance['ambulance_number'] ?>">
                                                    <span class="error-message" id="ambulancenumber-error"></span>
                                                    <input id="ambulanceId" hidden type="text" value="<?= $ambulanceId ?>">
                                                </div>
                                            </div>
                                            <div class="row mb-6">
                                                <label class="col-sm-2 col-form-label"
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="equipments"
                                                        placeholder="Enter Equipments" value="<?= $ambulance['equipment'] ?>">
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="size"
                                                        placeholder="Enter Size" value="<?= $ambulance['size'] ?>">
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="costprice"
                                                        placeholder="Enter Cost Price" value="<?= $ambulance['cost'] ?>">
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-control" id="type" name="type">
                                                        ...
                                                        <option <?= ($ambulance['type'] == 'Emergency')?'selected':'' ?> value="Emergency">Emergency</option>
                                                        <option  <?= ($ambulance['type'] == 'Non-Emergency')?'selected':'' ?> value="Non-Emergency">Non-Emergency</option>
                                                    </select>
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-control" id="status" name="status">
                                                        ...
                                                        <option <?= ($ambulance['status'] == 'available')?'selected':'' ?> value="available">Available</option>
                                                        <option <?= ($ambulance['status'] == 'maintenance')?'selected':'' ?> value="maintenance">Maintenance</option>
                                                    </select>
                                                    <span class="error-message" id="type-error"></span>
                                                </div>
                                            </div>
        ...
        $(document).ready(function () {
            ...
            $('#AddAmbulanceForm').submit(function (event) {
                ...
                if ($('.invalid').length === 0) {
                    ...
                    formData.append('ambulanceId', $('#ambulanceId').val());
                    formData.append('requestType', 'editAmbulance');
